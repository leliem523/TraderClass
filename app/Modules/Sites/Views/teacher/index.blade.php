...
@include('Sites::inc.maketting')
        ...
        <div class="img">
            ...
            <div class="text-center">
                ...
                <div class="info">
                    ...
                    @if (Auth::check())
                    <div class="continue">
                        <a href="/course/{{$course->id}}" style="color: white;">
                    ...
                    <div class="row">
                      ...
                      @if (Auth::check())
                        <div class="col-md-3" id="col-md-3">
                            <button><p> <a href="/log-into/course-selection/{{ $course->id }}"><i class="bi bi-plus-lg"></i> &ensp;Register the course</a></p></button>
    ...
    <div id="light">
        ...
        <iframe id="VisaChipCardVideo" src="https://www.youtube.com/embed/{{ $course->video_id }}" frameborder="0"></iframe>
