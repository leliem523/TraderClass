...
function closeOut(e) {
  console.log(e);
  jQuery('body')
    .toggleClass('scroll-jam')
    .append("<div class='sidebar_overlay' onclick='closeSidebar()'></div>");
  jQuery('#sidebar').toggleClass('nav-slide');
  jQuery('#mobile-nav>ul>.nav-item')
    .toggleClass('item-slide')
...
function sign_in() {
  ...
  function myfunc(e) {
    if (document.querySelector('.log-in').contains(e.target)) {
      ...
      header.classList.add('active');
      banner.classList.add('active');
      // sidebar.classList.remove('nav-slide');
    } else {
      // header.classList.remove('active');
      // banner.classList.remove('active');
      create_account.classList.remove('active2');
...
function close_popup() {
  ...
  log_in.classList.remove('active');
  reset_password.classList.remove('active');
  sidebar.classList.add('nav-slide');
  closeSidebar();
}
