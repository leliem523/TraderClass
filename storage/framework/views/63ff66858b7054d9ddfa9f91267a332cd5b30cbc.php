...
<?php echo $__env->make('Sites::inc.maketting', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="main">
        <div class="img">
            <img src="<?php echo e($course->photo); ?>" onerror="this.onerror=null; this.src='https://images.pexels.com/videos/3045163/free-video-3045163.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500'" width="100%" alt="">
...
<?php echo $__env->make('Sites::teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\2022\project-cty\main\TraderClass\app\Modules/Sites/Views/teacher/index.blade.php ENDPATH**/ ?>