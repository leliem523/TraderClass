...
<div class="create-account">
    ...
    <button class="btn-google" onclick="window.location='/login/google/redirect'"><a>SIGN UP WITH GOOGLE</a></button>
    <button class="btn-facebook" onclick="window.location='/login/facebook/redirect'"><a>SIGN UP WITH FACEBOOK</a></button>
...
<?php /**PATH E:\2022\project-cty\main\TraderClass\app\Modules/Sites/Views/inc/login.blade.php ENDPATH**/ ?>