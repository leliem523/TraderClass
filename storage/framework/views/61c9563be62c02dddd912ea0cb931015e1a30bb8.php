                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user"><?php echo e($value->id); ?></td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"  x-placement="bottom-start" >
                                                        ...
                                                        <a class="dropdown-item" href="/<?php echo e(Helper_Dashboard::get_patch()); ?>/video-course/<?php echo e($value->id); ?>"><i class="fa fa-eye"></i> Xem list Video</a>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\OneDrive\Máy tính\branch TraderClass\TraderClass\app\Modules/Dashboard/Views/course/index.blade.php ENDPATH**/ ?>