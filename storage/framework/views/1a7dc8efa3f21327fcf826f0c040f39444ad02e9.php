                ...
                <div class="col-md-6">
                    <div class="whitee">
                        <div class="pan">
                            ...
                            <div class="order">
                                <div class="un">
                                    <img src="<?php echo e($course->photo); ?>" alt="">
                                    <div id="yo2">
                                        <p><?php echo e($course->name); ?></p>
                                        <p id="cl_name"><?php echo e($course->fullname); ?></p>
                                    </div>
                                </div>
                                <div class="buy">
                                    <p id="price"><?php echo e(number_format($course_price->price)); ?> đ</p>
                            ...
                            <div class="total">
                                ...
                                <div id="se">
                                    <p><?php echo e(number_format($course_price->price)); ?> đ</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('Sites::courseIntroduction', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\branch-TraderClass\TraderClass\app\Modules/Sites/Views/course_selection/index.blade.php ENDPATH**/ ?>