...
<head>
    ...
    <link href="/public/sites/css/authentication/form-1.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->    
    <link rel="stylesheet" type="text/css" href="/public/sites/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="/public/sites/css/forms/switches.css">
</head>
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form action="/seller/register" class="text-left" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="form">
                                <div id="username-field" class="field-wrapper input">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="username" name="fullname" type="text" class="form-control" placeholder="Username">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                <div id="password-field" class="field-wrapper input mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                                    <input id="password" name="password_confirmation" type="password" value="" placeholder="Confirm your password ...">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                <?php if(isset($msg)): ?> 
                                    <div style="color: red"><?php echo e($msg); ?></div>
                                <?php endif; ?>
    ...
    <script src="/public/sites/js/authentication/form-1.js"></script>

</body>
</html><?php /**PATH E:\branch-TraderClass\TraderClass\app\Modules/Seller/Views/auth/register.blade.php ENDPATH**/ ?>