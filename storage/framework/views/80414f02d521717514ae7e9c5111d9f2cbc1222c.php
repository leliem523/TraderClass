                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="<?php echo e(Cookie::get('search_cryptocurrency_wallet')); ?>" placeholder="Tên ví...">
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/traderclass_dashboard/public_html/app/Modules/Dashboard/Views/cryptocurrency_wallet/index.blade.php ENDPATH**/ ?>