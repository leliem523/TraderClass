        ...
        <table>
            ...
            <tr class="footer-table">
                ...
                <td class="txt cen">
                    <p>2.000.000 ₫</p>
                    <h5>590.000 ₫</h5>
                    <h4 class="cous"><a style="color: white;" href="<?php echo e(url('/log-into/course-selection/'.$course->id)); ?>">BUY COURSE</a></h4>
                </td>
                <td class="txt dif">
                    <p>4.000.000 ₫</p>
                    <h5>990.000 ₫</h5>
                    <h4 class="pac"><a style="color: white;" href="<?php echo e(url('/log-into/'.$course->id)); ?>">BUY ACCESS PACKAGE</a></h4>
                </td>
            </tr>
        </table>
...
<?php echo $__env->make('Sites::courseIntroduction', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\OneDrive\Máy tính\branch TraderClass\TraderClass\app\Modules/Sites/Views/register/index.blade.php ENDPATH**/ ?>